...
enum MuseVibeCameraType {
    MUSEVIBE_CAMERA_NONE = 0,
    MUSEVIBE_CAMERA_OV2640 = 1,
    MUSEVIBE_CAMERA_OV3660 = 2,
    MUSEVIBE_CAMERA_GC2145 = 3,
    MUSEVIBE_CAMERA_UNKNOWN = 99,
};

#define MUSEVIBE_OV2640_PID_1 0x2640
#define MUSEVIBE_OV2640_PID_2 0x2626
#define MUSEVIBE_OV3660_PID 0x3660
#define MUSEVIBE_GC2145_PID 0x2145
