...
wn9_nihao_musevibe_tts-font_puhui_common_20_4-emojis_32.bin
"""
...
def build_assets(wakenet_model, text_font, emoji_collection, build_dir, final_dir):
    ...
    if emoji_collection != "none":
        emoji_path = os.path.join("../../components/78__xiaozhi-fonts/build", emoji_collection)
